...
######################### Converting to Ditto #################################################
     ...
     ## Converting transformer  into Ditto###############
        ...
        for obj in TransformerId:
            ...
            api_transformer.powerrating=TransformerRatedKvathisone
            api_transformer.primaryvoltage=HighSideRatedKv[Count]
            api_transformer.secondaryvoltage=LowSideRatedKv[Count]
    ...
    ## Convert load into Ditto
        ...
        for obj in LoadName:
            ...
            api_load.connecting_element=ToNodeId[Count]
            ...
            for obj in PhasesthisLoad:
                ...
                phase_loads.p=PLoad[t]
                phase_loads.q = QLoad[t]
